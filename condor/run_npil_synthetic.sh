...
python3 train_neural_pil.py --datadir /esat/topaz/gkouros/datasets/nerf/nerd/synthetic/$NAME --basedir logs/$NAME --expname $EXP --gpu $CUDA_VISIBLE_DEVICES --config configs/neural_pil/blender.txt --spherify
